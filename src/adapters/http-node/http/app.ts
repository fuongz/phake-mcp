...
import { contextRegistry } from "../../../runtime/node/context.js";
import { buildServer } from "../../../runtime/node/mcp.js";
...
import { createMcpSecurityMiddleware } from "../middleware.security.js";
import { buildDiscoveryRoutes } from "../routes.discovery.js";
...
export function buildHttpApp(): Hono<{ Bindings: HttpBindings }> {
	...
	const server = buildServer({
		name: unifiedConfig.MCP_TITLE || serverMetadata.title,
		version: unifiedConfig.MCP_VERSION,
		instructions: unifiedConfig.MCP_INSTRUCTIONS || serverMetadata.instructions,
